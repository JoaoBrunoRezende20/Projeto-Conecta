...
import 'telaAdminConteudoLojista.dart'; // Vamos criar abaixo
import 'telaAdminConteudoPrestador.dart'; // Vamos criar abaixo
...
class _TelaGerenciarUsuariosState extends State<TelaGerenciarUsuarios> with SingleTickerProviderStateMixin {
  ...
  Future<void> _gerarLog(String uidAlvo, String nomeAlvo, String acao, String justificativa) async {
    await FirebaseFirestore.instance.collection('logsAdministrativos').add({
      ...
      'acao': acao == 'EXCLUSAO', // false para ban/exclusão se seguir o padrão anterior
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text('Essa ação apagará os dados do usuário do banco de dados. Isso é irreversível!', style: TextStyle(color: Colors.red)),
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              trailing: isMe ? const Chip(label: Text('Você')) : IconButton(
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              subtitle: Text(colecao == 'lojistas' ? 'Toque para ver produtos' : 'Toque para ver portfólio'),
